...
const dentistNav = (dentistId: string): NavItem[] => [
  { label: 'Dashboard', href: '/dashboard', icon: <LayoutDashboard className="w-5 h-5" /> },
  { label: 'My Appointments', href: '/dashboard/appointments', icon: <Calendar className="w-5 h-5" /> },
  { label: 'My Patients', href: '/dashboard/patients', icon: <Users className="w-5 h-5" /> },
  { label: 'My Availability', href: `/dashboard/dentists/${dentistId}/availability`, icon: <Calendar className="w-5 h-5" /> },
...
export default async function DashboardLayout({
  ...
  if (userRole === 'DENTIST') {
    ...
    userAvatarUrl = dentist?.photoUrl || ''
    navItems = dentistNav(dentistId)
